...
// ---------------------------------------------------------------------------
// Vendored from animate-ui — imskyleen/animate-ui
// Adapted for Areculateir Hermes: mouse parallax kept, star color
// defaulted to white, no theme dependency required.
// ---------------------------------------------------------------------------
